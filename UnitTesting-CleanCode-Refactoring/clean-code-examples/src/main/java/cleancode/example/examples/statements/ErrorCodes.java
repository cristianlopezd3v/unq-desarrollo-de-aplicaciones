package cleancode.example.examples.statements;

import java.io.File;

import cleancode.example.examples.statements.support.ErrorCode;
import cleancode.example.examples.statements.support.FileData;
import cleancode.example.examples.statements.support.Status;
